...
<script>
    // Add Extra Slots date & time picker logic
...
$('#addSlotsFromDateBtn, #addSlotsUntilDateBtn').click(function(e){
  ...
  // Use your existing calendar modal, or reuse merge calendar logic
  let now = new Date();
...
// On calendar Done (reuse logic): set date text and .selected on btn
