...
(function($){
  ...
  let my_lessons_details_calendar_content_events = [
    { date:'2025-09-03', start:'07:00', end:'08:00', type:'confirmed', name:'Mary inamJanes', avatar:'https://randomuser.me/api/portraits/women/82.jpg', icon:'✔️' },
    { date:'2025-09-05', start:'07:00', end:'08:00', type:'recurring', name:'Mary Janes', avatar:'https://randomuser.me/api/portraits/women/68.jpg', icon:'🔄' },
    { date:'2025-09-07', start:'10:00', end:'11:00', type:'single',    name:'Mary Janes', avatar:'https://randomuser.me/api/portraits/women/82.jpg', icon:'📅' },
    { date:'2025-09-04', start:'13:00', end:'14:00', type:'single',    name:'Mary Janes', avatar:'https://randomuser.me/api/portraits/women/82.jpg', icon:'📅' },
    { date:'2025-09-04', start:'15:00', end:'16:00', type:'recurring', name:'Mary Janes', avatar:'https://randomuser.me/api/portraits/women/68.jpg', icon:'🔄' },
    { date:'2025-09-06', start:'16:00', end:'17:00', type:'confirmed', name:'Mary Janes', avatar:'https://randomuser.me/api/portraits/women/12.jpg', icon:'✔️' },
