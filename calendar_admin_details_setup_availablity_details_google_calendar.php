...
<style>
  ...
  body{
    background:#f7f7fb; color:#111; font-family:"Inter",system-ui,-apple-system,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif;
  }

  .calendar_admin_details_setup_availability_google_calendar_wrap{ padding:28px 12px; }
  .calendar_admin_details_setup_availability_google_calendar_title{
    font-weight:800; font-size:clamp(22px,2.4vw,30px); margin-bottom:18px;
  }

  /* Banner */
  .calendar_admin_details_setup_availability_google_calendar_banner{
    background:var(--gc-green); border:1px solid #c7eee5; border-radius:16px; padding:18px; position:relative;
  ...
  .calendar_admin_details_setup_availability_google_calendar_badge{
    width:44px; height:44px; border-radius:50%; background:#19b68e; display:grid; place-items:center;
  ...
  .calendar_admin_details_setup_availability_google_calendar_disconnect{
    background:#d9f6ef; border:2px solid #0c0c0c; color:#0c0c0c; border-radius:10px; padding:10px 16px;
  }
  ...
  .calendar_admin_details_setup_availability_google_calendar_listcard{
    background:#fff; border:1px solid var(--gc-border); border-radius:12px; overflow:hidden;
  }
  .calendar_admin_details_setup_availability_google_calendar_listrow{
    display:flex; align-items:center; gap:12px; padding:16px 18px; border-top:1px solid var(--gc-border);
  }
  .calendar_admin_details_setup_availability_google_calendar_listrow:first-child{ border-top:none; }

  /* Custom checkbox */
  .calendar_admin_details_setup_availability_google_calendar_check{
    position:relative; width:22px; height:22px; border-radius:6px; border:2px solid #d1d5db; background:#fff; flex:0 0 22px; cursor:pointer;
  }
  .calendar_admin_details_setup_availability_google_calendar_check[data-checked="true"]{
    background:#fe3a2f; border-color:#fe3a2f;
  }
  .calendar_admin_details_setup_availability_google_calendar_check svg{
    position:absolute; inset:0; margin:auto; width:14px; height:14px; display:none;
  }
  .calendar_admin_details_setup_availability_google_calendar_check[data-checked="true"] svg{ display:block; fill:#fff; }
  ...
  .calendar_admin_details_setup_availability_google_calendar_check[aria-disabled="true"]{
    background:#f1f2f5; border-color:#e1e3e8; cursor:not-allowed;
  }
  ...
  .calendar_admin_details_setup_availability_google_calendar_block_desc{
    color:var(--gc-muted); margin-top:10px; max-width:70ch; line-height:1.55;
  }

  /* Save button */
  .calendar_admin_details_setup_availability_google_calendar_save{
    margin-top:22px; background:var(--gc-red); color:#fff; padding:14px 34px; font-weight:700; border-radius:10px;
  ...
  @media (max-width: 576px){
    ...
    .calendar_admin_details_setup_availability_google_calendar_disconnect{ align-self:stretch; text-align:center; }
  }
</style>

<div class="container calendar_admin_details_setup_availability_google_calendar_wrap">
...
<div class="calendar_admin_details_setup_availability_google_calendar_banner">
  <div class="calendar_admin_details_setup_availability_google_calendar_banner_left">
    ...
    <div class="calendar_admin_details_setup_availability_google_calendar_badge" aria-hidden="true" style="background:#007f5f;">
  ...
  <!-- Choose calendars -->
  <div class="calendar_admin_details_setup_availability_google_calendar_label">
    Choose which Google Calendars you’d like to see on Latingles
  </div>
  <div class="calendar_admin_details_setup_availability_google_calendar_listcard" id="calendar_admin_details_setup_availability_google_calendar_list">
    <!-- Row 1 (checked) -->
    <div class="calendar_admin_details_setup_availability_google_calendar_listrow"
         data-key="primary">
      <div class="calendar_admin_details_setup_availability_google_calendar_check"
           role="checkbox" tabindex="0" aria-checked="true" data-checked="true" aria-label="Primary calendar">
        <svg viewBox="0 0 24 24"><path d="M20.285 6.709a1 1 0 0 0-1.414-1.418l-9.9 9.9-3.84-3.84a1 1 0 1 0-1.414 1.415l4.547 4.546a1 1 0 0 0 1.414 0l10.007-10.603Z"/></svg>
      </div>
    ...
    <!-- Row 2 (disabled / grey) -->
    <div class="calendar_admin_details_setup_availability_google_calendar_listrow"
         data-key="on_latingles">
      <div class="calendar_admin_details_setup_availability_google_calendar_check"
           role="checkbox" aria-disabled="true" aria-checked="false" data-checked="false" aria-label="On latingles (disabled)"></div>
      <div class="calendar_admin_details_setup_availability_google_calendar_rowtext calendar_admin_details_setup_availability_google_calendar_row_disabled">
        On latingles
      </div>
    </div>
  </div>
  ...
  <div class="calendar_admin_details_setup_availability_google_calendar_blockwrap">
    <div class="calendar_admin_details_setup_availability_google_calendar_blockbox">
      <div class="calendar_admin_details_setup_availability_google_calendar_check"
           id="calendar_admin_details_setup_availability_google_calendar_block_checkbox"
           role="checkbox" aria-checked="false" data-checked="false" tabindex="0" aria-label="Allow Google Calendar events to block your availability">
        <svg viewBox="0 0 24 24"><path d="M20.285 6.709a1 1 0 0 0-1.414-1.418l-9.9 9.9-3.84-3.84a1 1 0 1 0-1.414 1.415l4.547 4.546a1 1 0 0 0 1.414 0l10.007-10.603Z"/></svg>
      </div>
  ...
  <!-- Save -->
  <button class="calendar_admin_details_setup_availability_google_calendar_save" id="calendar_admin_details_setup_availability_google_calendar_savebtn">Save</button>
</div>
