...
<div class="noSelect">
    ...
    .filter { position: relative; min-width: 200px; }
    .filter-button {
      width: 100%; border: 1px solid var(--border); border-radius: 8px;
      background: var(--bg); padding: 12px; cursor: pointer;
    }
    .filter-button.open { border-color: var(--border-focus); }
    .filter-button .label { display: block; font-size: 12px; color: var(--text-muted); margin-bottom: 4px; }
    ...
    .search-wrapper input {
      ...
      border-radius: 6px; background: var(--input-bg); font-size: 14px;
    }
    ...
    .dropdown_filters li.section-label {
      padding: 8px 12px; font-size: 14px; font-weight: 600; color: var(--text-section);
    }
    ...
    .checkbox.selected::after { content: "\2713"; color: #fff; font-size: 14px; }
    ...
    /* Slider */
    .slider-dropdown { padding: 12px; }
    .slider-dropdown .range-label {
      text-align: center; font-size: 16px; font-weight: 600; margin-bottom: 12px;
    }
    .slider-container {
    ...
    /* ---------- Teachers Section ---------- */
    #teacherSection { margin-top: 32px; }
    #teacherSection h2 { font-size: 24px; margin-bottom: 16px; }
    #teacherSection .card-wrapper { display: flex; gap: 16px; align-items: flex-start; }
    #teacherSection .teacher-card {
      flex: 2; display: flex; background: var(--bg);
    ...
    #teacherSection .top-row {
      display: flex; justify-content: space-between; align-items: center;
    }
    #teacherSection .top-row h3 {
      margin: 0; font-size: 20px; display: flex; align-items: center; gap: 4px;
    }
    #teacherSection .verified { color: var(--border-focus); font-size: 18px; }
    #teacherSection .favorite {
      background: transparent; border: none; font-size: 18px;
      cursor: pointer; color: var(--text-muted);
    }
    #teacherSection .meta-grid {
      display: grid; grid-template-columns: 1fr; gap: 8px;
      font-size: 14px; color: var(--text-muted); margin: 12px 0;
    }
    #teacherSection .meta-grid div {
      display: flex; align-items: center; gap: 6px;
    }
    #teacherSection .bio {
      flex: 1; font-size: 14px; line-height: 1.4;
      margin-bottom: 8px; overflow: hidden; max-height: 3em;
    }
    #teacherSection .bio.expanded { max-height: none; }
    #teacherSection .see-more {
      font-size: 14px; color: var(--accent);
      text-decoration: none; cursor: pointer; margin-bottom: 16px;
    }
    #teacherSection .teacher-actions {
      flex: none; width: 220px; display: flex; flex-direction: column;
      padding: 16px; border-left: 1px solid var(--border);
      gap: 16px; align-items: stretch;
    }
    #teacherSection .rating {
      text-align: right;
    }
    #teacherSection .rating .star-rate {
      font-size: 20px; font-weight: 600;
    }
    #teacherSection .rating small {
      display: block; font-size: 12px;
      color: var(--text-muted); margin-top: 2px;
    }
    #teacherSection .stats-grid {
      text-align: right; font-size: 16px;
      font-weight: 600; line-height: 1.2;
    }
    #teacherSection .stats-grid small {
    ...
    #teacherSection .schedule-card {
      flex: 1; background: var(--bg);
      border: 1px solid var(--border); border-radius: 8px;
      display: flex; flex-direction: column; overflow: hidden;
    }
    #teacherSection .preview {
      position: relative; width: 100%; height: 0;
      padding-top: 56.25%; background: #eee center/cover url('https://via.placeholder.com/280x160');
    }
    #teacherSection .preview::after {
      content: '▶'; position: absolute; top: 50%; left: 50%;
      transform: translate(-50%, -50%); font-size: 32px;
      color: var(--accent); background: rgba(255,255,255,0.8);
      border-radius: 50%; width: 48px; height: 48px;
      line-height: 48px; text-align: center;
    }
    #teacherSection .schedule-btn {
      margin: 16px; padding: 12px; border: none;
  ...
  <section id="teacherSection">
    <h2>500 English Teachers Available</h2>
    <div class="card-wrapper">
      <!-- Teacher profile card -->
      <div class="teacher-card">
        <img src="https://randomuser.me/api/portraits/women/4.jpg" alt="Daniela" class="profile">
        <div class="teacher-details">
          <div class="top-row">
            <h3>Daniela <span class="verified">✔️</span></h3>
            <button class="favorite">♡</button>
          </div>
          <div class="meta-grid">
            <div>🎓 English</div>
            <div>👥 30 active students • 1,260 lessons</div>
        ...
        <div class="teacher-actions">
          <div class="rating">
            <span class="star-rate">★ 4.7</span>
            <small>17 reviews</small>
          </div>
          <div class="stats-grid">
            <div>858<br><small>lessons</small></div>
            <div>US$8<br><small>50-min lesson</small></div>
          </div>
          <button class="btn-primary">Book Lesson</button>
