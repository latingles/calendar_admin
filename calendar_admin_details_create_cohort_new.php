...
<body>
  ...
  <div id="calendar_admin_details_create_cohort_modal_backdrop">
    <div id="calendar_admin_details_create_cohort_modal">
      ...
      <!-- Conference Tab Content (shown for conference and peer talk tabs) -->
      <div class="calendar_admin_details_create_cohort_content tab-content" id="conferenceTabContent" style="display:none;">
        <!-- (Conference scheduling content, unchanged) -->
  ...
  <script>
    $(document).ready(function () {
      ...
      $('.calendar_admin_details_create_cohort_tab').click(function () {
        ...
        $('#conferenceTabContent').toggle(tab === "conference" || tab === "peertalk");
