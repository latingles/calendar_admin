...
.calendar_admin_details_cohort_tab_time_divider {
  width: 24px;         /* Adjust width to your need */
  height: 2px;
          ...
          <div>
            ...
            <div class="calendar_admin_details_create_cohort_class_dropdown_wrapper">
              ...
              <div class="calendar_admin_details_cohort_tab_time_buttons_row">
                <button class="calendar_admin_details_cohort_tab_time_btn_1">Start Time</button>
                <div class="calendar_admin_details_cohort_tab_time_divider"></div>
                <button class="calendar_admin_details_cohort_tab_time_btn_1">End Time</button>
              </div>
