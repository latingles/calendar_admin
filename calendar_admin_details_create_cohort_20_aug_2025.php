    ...
    <div id="calendar_admin_details_create_cohort_modal">
      ...
      <div class="calendar_admin_details_create_cohort_content" id="mainModalContent">
        ...
        <div class="container-fluid">
            <div class="row mb-3 position-relative" style="margin-right:-30px; margin-left:-30px;">
              <!-- Cohort -->
              <div class="col-md-6 position-relative">
                <label for="cohortInput" class="form-label" style="font-weight:500; color:#232323; font-size:1.15rem;">Cohort</label>
                <input type="text" class="form-control cohort-tooltip-target" id="cohortInput" placeholder="XXX-#-#####-###" 
                  style="border-radius:12px; border:1.5px solid #e3e3e7; font-size:1.15rem; color:#818191; font-weight:500; background:#fff; letter-spacing:2px; height:50px;">
                <!-- Tooltip -->
                <div class="custom-tooltip" id="tooltip-cohort" style="display:none;">
              ...
              <!-- Cohort's Short Name -->
              <div class="col-md-6 position-relative">
                <label for="cohortShortInput" class="form-label" style="font-weight:500; color:#232323; font-size:1.15rem;">Cohort’s Short Name</label>
                <input type="text" class="form-control cohort-tooltip-target" id="cohortShortInput" placeholder="XX#" 
                  style="border-radius:12px; border:1.5px solid #e3e3e7; font-size:1.15rem; color:#818191; font-weight:500; background:#fff; letter-spacing:2px; height:50px;">
                <!-- Tooltip -->
                <div class="custom-tooltip" id="tooltip-cohortshort" style="display:none;">
                  <span style="font-size:1.2em;vertical-align:-2px;margin-right:6px;">&#9432;</span>
                  Start selecting below
                </div>
              </div>
