    ...
    <div id="my_lessons_tutor_profile_left">
      ...
      <div class="my_lessons_tutor_profile_intro">
        <div class="my_lessons_tutor_profile_image-wrapper">
          <img src="https://i.imgur.com/zFz5zoQ.jpg" alt="Daniela" class="my_lessons_tutor_profile_image">
        </div>
        <div class="my_lessons_tutor_profile_header">
          <h1>Daniela <span class="my_lessons_tutor_profile_verified">✔️</span></h1>
          ...
          <ul class="my_lessons_tutor_profile_features">
            <li>🔄 Trials are 100% refundable</li>
            <li>🎓 Teaches English lessons</li>
          </ul>
        </div>
      </div>
      ...
      <section class="my_lessons_tutor_profile_about">
        <h2>About me</h2>
        <p>Hi! I’m Daniela, an experienced English teacher with over a decade of helping students master the language. I’m passionate about creating engaging, personalized lessons that align with each student’s unique goals and learning style...</p>
      </section>

      <!-- Languages -->
      <section class="my_lessons_tutor_profile_languages">
        <h2>I speak</h2>
        <div>
      ...
      <!-- Reviews -->
      <section id="my_lessons_tutor_profile_reviews_section">
        <h2>What my students say</h2>
        <button class="my_lessons_tutor_profile_toggle_reviews" style="margin-left: 80%;margin-top:-40px; margin-bottom: 20px;" id="my_lessons_tutor_profile_details_post_review_trigger">Post Review</button>
        <!-- Rating summary -->
        ...
        <div id="my_lessons_tutor_profile_reviews_list" class="my_lessons_tutor_profile_collapsed">
          <div class="my_lessons_tutor_profile_review_item">
            <img src="https://i.imgur.com/abc123.jpg" alt="Efren" class="my_lessons_tutor_profile_review_avatar">
            <div class="my_lessons_tutor_profile_review_meta">
              <div class="my_lessons_tutor_profile_review_header">
                <strong>Efren</strong> <span>September 14, 2024</span>
              </div>
              <div class="my_lessons_tutor_profile_review_stars">★★★★★</div>
              <div class="my_lessons_tutor_profile_review_text">Great!</div>
            </div>
          ...
          <div class="my_lessons_tutor_profile_review_item">
            <img src="https://i.imgur.com/xyz456.jpg" alt="mayte" class="my_lessons_tutor_profile_review_avatar">
            <div class="my_lessons_tutor_profile_review_meta">
              <div class="my_lessons_tutor_profile_review_header">
                <strong>mayte</strong> <span>July 29, 2024</span>
              </div>
              <div class="my_lessons_tutor_profile_review_stars">★★★★☆</div>
              <div class="my_lessons_tutor_profile_review_text">My class ended early</div>
               <a href="#" class="my_lessson_tutor_profile_detail_show_more_trigger">Show More</a>
            </div>
          ...
          <div class="my_lessons_tutor_profile_review_item">
            ...
            <div class="my_lessons_tutor_profile_review_meta">
              ...
              <div class="my_lessons_tutor_profile_review_stars">★★★★★</div>
              <div class="my_lessons_tutor_profile_review_text">
                He is an excellent teacher with incredible patience and effective teaching methods…
              </div>
            </div>
          </div>
          <div class="my_lessons_tutor_profile_review_item">
            <img src="https://i.imgur.com/def789.jpg" alt="Kathryn Murphy" class="my_lessons_tutor_profile_review_avatar">
            <div class="my_lessons_tutor_profile_review_meta">
              <div class="my_lessons_tutor_profile_review_header">
                <strong>Kathryn Murphy</strong> <span>September 14, 2024</span>
              </div>
              <div class="my_lessons_tutor_profile_review_stars">★★★★★</div>
              <div class="my_lessons_tutor_profile_review_text">
        ...
        <button class="my_lessons_tutor_profile_toggle_reviews my_lessson_tutor_profile_detail_show_more_trigger">
          Show all 8 reviews
        </button>
      ...
      <!-- Schedule -->
      <section id="my_lessons_tutor_profile_schedule">
        <h2>Schedule</h2>
        <div class="my_lessons_tutor_profile_notice">
        ...
        <div class="my_lessons_tutor_profile_week_nav">
          <button id="my_lessons_tutor_profile_prev_week">&lt;</button>
          <span id="my_lessons_tutor_profile_week_label">Mar 11–17, 2025</span>
          <button id="my_lessons_tutor_profile_next_week">&gt;</button>

          <div class="my_lessons_tutor_profile_timezone_select">
            <span id="my_lessons_tutor_profile_timezone_label">America/New_York GMT -4:00</span>
            <span class="arrow">▼</span>
            <ul id="my_lessons_tutor_profile_timezone_dropdown">
              <li>America/New_York GMT -4:00</li>
              <li>Europe/London GMT +1:00</li>
              <li>Asia/Tokyo GMT +9:00</li>
            </ul>
          </div>
        </div>
        ...
        <div class="my_lessons_tutor_profile_slots">
          <!-- Tue 11 -->  
          <div class="my_lessons_tutor_profile_day">
            <div class="my_lessons_tutor_profile_day_label">Tue<br><span>11</span></div>
  ...
  <section id="my_lesson_tutor_profile_my_specialities">
  ...
  <div class="my_lesson_tutor_profile_my_specialities_item">
    <div class="my_lesson_tutor_profile_my_specialities_header">
      ...
      <span class="my_lesson_tutor_profile_my_specialities_arrow">▼</span>
    </div>
    ...
    <div id="my_lessons_tutor_profile_right">
      <div class="my_lessons_tutor_profile_card">
        <div class="my_lessons_tutor_profile_card_media">
          <img src="https://i.imgur.com/zFz5zoQ.jpg" alt="Lesson preview" class="my_lessons_tutor_profile_card_img">
          <div class="my_lessons_tutor_profile_card_play">▶︎</div>
        </div>
        <div class="my_lessons_tutor_profile_card_stats">
          <div class="my_lessons_tutor_profile_rating">
            <span class="my_lessons_tutor_profile_rating_star">★</span>
            <span class="my_lessons_tutor_profile_rating_value">4.7</span>
            <span class="my_lessons_tutor_profile_rating_reviews">17 reviews</span>
          </div>
          <div class="my_lessons_tutor_profile_lessons">858 lessons</div>
          <div class="my_lessons_tutor_profile_price">US$8 / 50-min lesson</div>
        </div>
        <div class="my_lessons_tutor_profile_card_actions">

          <button  id="my_lessons_tutor_profile_details_book_trial_lesson_btn" class="my_lessons_tutor_profile_btn my_lessons_tutor_profile_btn_primary">⚡ Book trial lesson</button>

          <button class="my_lessons_tutor_profile_btn my_lessons_tutor_profile_btn_outline" id="open_step1">💬 Send a Message</button>
          <button class="my_lessons_tutor_profile_btn my_lessons_tutor_profile_btn_outline">♡ Save to my list</button>
        </div>
        <div class="my_lessons_tutor_profile_card_footer">
          <div class="my_lessons_tutor_profile_popular">📈 Popular • 32 lesson bookings in the last 48 hours</div>
          <div class="my_lessons_tutor_profile_response">⏱ Usually responds in 2 hours</div>
        </div>
      </div>
    </div><!-- /right -->
 </div><!-- /container -->
