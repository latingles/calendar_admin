  ...
  <div class="modal2-content">
    ...
    <form style="margin-top:25px;">
      ...
      <div class="modal-row">
        ...
        <div class="modal-col" style="flex:1.1; position:relative;">
          <input class="custom-input" id="supercal-open-btn_due_on" style="padding-right:32px; cursor:pointer;" readonly value="1 Oct, 2024">
          <span class="icon-btn" style="right:20px; top:25px; font-size:1.28rem; pointer-events:none;">
            <svg width="20" height="20" fill="none" viewBox="0 0 20 20"><rect width="20" height="20" rx="4" fill="#F6F6F6"/><path d="M6.5 3v2M13.5 3v2M4.2 7.2h11.6M5 17h10a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1Z" stroke="#232323" stroke-width="1.3" stroke-linecap="round"/></svg>
          </span>
...
<div class="supercal-modal" id="supercal-modal">
  ...
  <div class="supercal-time-row">
    <select id="supercal-hour" class="supercal-time-select"></select>
    <span class="supercal-time-colon">:</span>
    <select id="supercal-minute" class="supercal-time-select"></select>
    <select id="supercal-ampm" class="supercal-time-select"></select>
  </div>
