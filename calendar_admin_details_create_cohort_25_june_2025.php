...
<div class="one2one-tab-content">
  ...
  <div class="one2one-add-student-card">
    <span class="one2one-add-student-icon">
      <!-- Simple user icon SVG -->
      <svg width="21" height="21" viewBox="0 0 20 20" fill="none"><circle cx="10" cy="7" r="4" fill="#c5c7cd"/><ellipse cx="10" cy="15.3" rx="6.5" ry="3.3" fill="#c5c7cd"/></svg>
    </span>
    Add student
  </div>
  ...
  <div class="one2one-lesson-type-row">
    <div class="one2one-lesson-type-btn selected">
      ...
      Single lessons
      <input type="radio" class="one2one-radio" name="lessonType" checked>
    </div>
    <div class="one2one-lesson-type-btn">
      <span class="one2one-lesson-type-icon">
        <!-- Repeat/refresh icon SVG -->
      ...
      Weekly lessons
      <input type="radio" class="one2one-radio" name="lessonType">
    </div>
  </div>

  <label class="one2one-section-label">Date and time</label>
  <select class="one2one-datetime-dropdown">
    <option>50 Minutes ( Standard time )</option>
    <!-- More options -->
  </select>
  <div class="one2one-datetime-dropdown-row">
    <select>
      <option>Tue, Feb11</option>
      <!-- More dates -->
    </select>
    <select>
