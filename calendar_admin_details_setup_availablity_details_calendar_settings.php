...
<style>
  ...
  .calendar_admin_details_setup_availability_calendar_settings_section{ padding:28px 12px; }
  ...
  .calendar_admin_details_setup_availability_calendar_settings_label{
    font-weight:700; margin-bottom:6px; font-size:18px; color:#1b1c1f;
  }
  .calendar_admin_details_setup_availability_calendar_settings_tip{
    color:#6b6f7b; max-width:62ch; line-height:1.5;
  }
  ...
  /* === Custom Select === */
  .calendar_admin_details_setup_availability_calendar_settings_select{ position:relative; width:100%; }
  .calendar_admin_details_setup_availability_calendar_settings_selectbtn{
    width:100%; display:flex; justify-content:space-between; align-items:center;
    border:2px solid #a4a4a4; background:#fff; padding:14px 16px;
    border-radius:14px;  color:#111;
    /* box-shadow:0 3px 0 rgba(0,0,0,.20); */
    cursor:pointer;
  }
  .calendar_admin_details_setup_availability_calendar_settings_caret{ margin-left:12px; flex:0 0 auto; }
  ...
  .calendar_admin_details_setup_availability_calendar_settings_select.open
    > .calendar_admin_details_setup_availability_calendar_settings_menu{ display:block; }

  .calendar_admin_details_setup_availability_calendar_settings_item{
    padding:16px 22px; color:#111; cursor:pointer;
  }
  ...
  .calendar_admin_details_setup_availability_calendar_settings_savebtn{
    background:#fe2e0c; border:none; border-radius:10px;
  ...
  .calendar_admin_details_setup_availability_calendar_settings_savebtn:hover{ background:#e53935; }
</style>

<div class="container calendar_admin_details_setup_availability_calendar_settings_section">
  ...
  <div class="row g-3 align-items-stretch">
    <div class="col-12 col-lg-7">
      <div class="calendar_admin_details_setup_availability_calendar_settings_card h-100">
        ...
        <div class="calendar_admin_details_setup_availability_calendar_settings_tip">
          Choose your current time zone to avoid time zone confusion with your students. Customize calendar view the way it suits you.
        </div>
      </div>
    </div>
    ...
    <div class="col-12 col-lg-5">
      <div class="calendar_admin_details_setup_availability_calendar_settings_control">
        <div class="calendar_admin_details_setup_availability_calendar_settings_control_title">Current time zone</div>

        <div class="calendar_admin_details_setup_availability_calendar_settings_select" id="calendar_admin_details_setup_availability_calendar_settings_timezone_select">
          <button type="button" class="calendar_admin_details_setup_availability_calendar_settings_selectbtn">
            <span class="calendar_admin_details_setup_availability_calendar_settings_value">America/Caracas GMT -4:00</span>
            <svg class="calendar_admin_details_setup_availability_calendar_settings_caret" width="18" height="18" viewBox="0 0 20 20">
          ...
          <div class="calendar_admin_details_setup_availability_calendar_settings_menu">
            <div class="calendar_admin_details_setup_availability_calendar_settings_item" data-value="EST">EST (Eastern Standard Time) – UTC -5</div>
            <div class="calendar_admin_details_setup_availability_calendar_settings_item" data-value="PST">PST (Pacific Standard Time) – UTC -8</div>
            <div class="calendar_admin_details_setup_availability_calendar_settings_item" data-value="CST">CST (Central Standard Time) – UTC -6</div>
            <div class="calendar_admin_details_setup_availability_calendar_settings_item" data-value="IST">IST (Indian Standard Time) – UTC +5:30</div>
            <div class="calendar_admin_details_setup_availability_calendar_settings_item" data-value="GMT">GMT (Greenwich Mean Time) – UTC 0</div>
          </div>
        </div>
...
<script>
  ...
  $(function(){
    ...
    $(document).on('click', function(){ calendar_admin_details_setup_availability_calendar_settings_closeAll(); });
    $(document).on('keydown', function(e){ if(e.key==="Escape") calendar_admin_details_setup_availability_calendar_settings_closeAll(); });

    $('.calendar_admin_details_setup_availability_calendar_settings_savebtn').on('click',function(){
      alert("Saved timezone: "+calendar_admin_details_setup_availability_calendar_settings_state.timezone);
    });
  });
</script>
